          ...
          <thead class="text-[11px] font-black uppercase text-gray-400 bg-gray-50/50 dark:bg-gray-900/50 dark:text-gray-500 border-b border-gray-100 dark:border-gray-700">
            <tr>
              ...
              <th scope="col" class="px-6 py-5 cursor-pointer group" @click="sort('coupon_value')">
                <div class="flex items-center group-hover:text-blue-500 transition-colors">
                  Coupon
                  <svg class="w-3 h-3 ml-1.5 opacity-0 group-hover:opacity-100 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </div>
              </th>
              ...
              <th scope="col" class="px-6 py-5 cursor-pointer group text-right" @click="sort('price')">
                <div class="flex items-center justify-end group-hover:text-blue-500 transition-colors">
                  Prezzo
                  <svg class="w-3 h-3 ml-1.5 opacity-0 group-hover:opacity-100 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </div>
              </th>
              <th scope="col" class="px-6 py-5 cursor-pointer group text-center" @click="sort('DIFF')">
                <div class="flex items-center justify-center group-hover:text-blue-500 transition-colors">
                  Δ %
                  <svg class="w-3 h-3 ml-1.5 opacity-0 group-hover:opacity-100 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </div>
              </th>
