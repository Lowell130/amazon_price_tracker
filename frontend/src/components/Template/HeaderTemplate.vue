              ...
              <div v-if="isAdmin" class="relative group" @mouseenter="clearCloseTimeout('admin'); isAdminDropdownOpen = true" @mouseleave="closeWithDelay('admin')">
                ...
                <div v-show="isAdminDropdownOpen" class="absolute left-0 mt-0 pt-2 w-48 bg-transparent z-50">
                  <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 py-2 animate-fadeIn">
                    ...
                    <router-link to="/admin/trends" class="flex items-center px-4 py-2.5 text-sm text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400">
                      <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                      Trend Explorer
                    </router-link>
          ...
          <div class="px-6 py-8 space-y-6">
            ...
            <template v-if="isAuthenticated">
              ...
              <div v-if="isAdmin" class="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                <router-link to="/admin/trends" @click="isMobileMenuOpen = false" class="flex items-center p-3 rounded-2xl text-lg font-bold text-gray-900 dark:text-white">
                  <svg class="w-5 h-5 mr-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg> Trend Explorer
                </router-link>
