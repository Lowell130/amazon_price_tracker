...
export default {
  ...
  data() {
    return {
      ...
      categories: [
       "Audio", "Automotive", "Baby Products", "Beauty Care", "Books", "DIY", "Electronics", "Fashion", "Gaming", "Garden", "Groceries", "Health & Wellness", "Home", "Kitchen", "Memory", "Monitor", "Notebook", "Office Supplies", "PC", "Pets", "Smart-TV", "Smartphones", "Smartwatches", "Sports", "Tablet", "Technology", "Toys & Games", "Travel Gear", "Video", "Watch", "WiFi"
