      ...
      >
        <div class="flex-1 flex items-center space-x-2">
          <span class="pl-5 pt-4 text-sm text-gray-900 dark:text-white"
            >Hello: <span class="font-bold">{{ username }}</span></span
          >
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      categories: [
       "Audio", "Automotive", "Baby Products", "Beauty Care", "Books", "DIY", "Electronics", "Fashion", "Gaming", "Garden", "Groceries", "Health & Wellness", "Home", "Kitchen", "Monitor", "Notebook", "Office Supplies", "PC", "Pets", "Smart-TV", "Smartphones", "Smartwatches", "Sports", "Tablet", "Technology", "Toys & Games", "Travel Gear", "Video", "Watch"
